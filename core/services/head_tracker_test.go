...
func TestHeadTracker_SwitchesToLongestChain(t *testing.T) {
	...
	checker.On("OnNewLongestChain", mock.MatchedBy(func(h models.Head) bool {
		return h.Number == blockHeaders[0].Number.ToInt().Int64()
	})).Return().Once()
	checker.On("OnNewLongestChain", mock.MatchedBy(func(h models.Head) bool {
		return h.Number == blockHeaders[1].Number.ToInt().Int64()
	})).Return().Once()
	checker.On("OnNewLongestChain", mock.MatchedBy(func(h models.Head) bool {
		if h.Number == blockHeaders[3].Number.ToInt().Int64() {
	...
	checker.On("OnNewLongestChain", mock.MatchedBy(func(h models.Head) bool {
		if h.Number == blockHeaders[8].Number.ToInt().Int64() {
