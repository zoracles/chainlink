...
contract('Coordinator', () => {
  ...
  describe('#getId', async () => {
    it('matches the ID generated by the oracle off-chain', async () => {
      const sA = await newServiceAgreement({
        payment: 1,
        expiration: 2,
        requestDigest:
    ...
    context('cooperative consumer', () => {
      ...
      context('when called by an owner', () => {
        ...
        it("calls the aggregator with the oracle's result", async () => {
          ...
          assert.equal(h.oracleNode, event.args.oracle)
        })
        ...
        it.only('reports errors from the aggregator, such as double-reporting', async () => {
          const meanServiceAgreement = await newServiceAgreement({
            ...agreement,
          ...
          const meanTx = await link.transferAndCall(
            coordinator.address,
            meanServiceAgreement.payment,
            payload,
            { value: 0 }
          )
